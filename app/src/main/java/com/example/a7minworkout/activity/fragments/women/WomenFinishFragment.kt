...
import com.example.a7minworkout.databinding.FragmentWomenFinishBinding


class WomenFinishFragment : Fragment() {
private lateinit var binding: FragmentWomenFinishBinding
    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        // Inflate the layout for this fragment
        binding=FragmentWomenFinishBinding.inflate(inflater, container, false)
