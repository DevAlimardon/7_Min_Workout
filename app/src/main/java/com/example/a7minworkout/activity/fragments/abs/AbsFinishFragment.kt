...
import com.example.a7minworkout.databinding.FragmentAbsFinishBinding

class AbsFinishFragment : Fragment() {

    private lateinit var binding: FragmentAbsFinishBinding
    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        // Inflate the layout for this fragment
        binding = FragmentAbsFinishBinding.inflate(inflater, container, false)
